    ...
    <div className={styles.articles}>
      <div className={styles.cover}>
        <div className={styles.cover_container}>
          <Image
            src={get(article, "thumbnail.data.attributes.url")}
            alt=""
            layout="fill"
          ...
          <div className={styles.articles_container}>
                ...
                <>
                  ...
                  <div className="my-7">
                    <Carousel responsive={infoCardResponsive}>
                      {get(article, "biz_listings.data")?.map(
                        (card: any, index) => (
                          <InforCard
                            key={index}
                            imgUrl={
            ...
            <div
              dangerouslySetInnerHTML={{
                __html: converter.makeHtml(get(article, "content")),
              }}
            ></div>
            ...
            >
              <Carousel responsive={homeCuratedResponsive}>
                {get(article, "related_articles.data")?.map((item, index) => (
                  <Link
                    href={`/articles/${get(item, "attributes.slug")}`}
                    key={index}
                    passHref
                  >
