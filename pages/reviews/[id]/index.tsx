            ...
            <div className={`${styles.container_left} ${dividerVerticalClassName}`}>
              ...
              <div className={`${styles.review_card} mb-0 sm:mb-7`}>
                <div className={styles.featured_image}>
                  ...
                  <Image
                    src={get(bizListing, "attributes.images[0]") || "https://picsum.photos/300/600"}
                    width="100%"
                    height="56%"
                    layout="responsive"
                ...
                <div className="w-full">
                  <h4 className={styles.title}>{get(bizListing, "attributes.name")}</h4>
                  <div className={styles.location}>{get(bizListing, "attributes.address")}</div>
                </div>
              </div>
              <p className={`${styles.note} mb-8`}>
                Your first-hand experiences would help and inspire our fellow Tribes member to get
                ideas and make better planning. Thank you!
              </p>
