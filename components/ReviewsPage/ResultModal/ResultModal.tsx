...
let resultType = [
  {
    title: "Thank you",
    message: "Thank you for sharing your experience and helping to improve this listing!",
    textButton: "Close",
  },
  {
    title: "Uh...oh...",
    ...
    <Modal visible={visible} width={452} mobilePosition="center">
      <div className="flex flex-col items-center justify-between mx-auto p-8">
        <div className={styles.image_container}>
          <Image
            className="mb-5"
            src={isSuccess ? require("public/images/success-submit.svg") : require("public/images/failed-submit.svg")}
            width="100%"
            height="100%"
            layout="responsive"
            alt="icon"
        ...
        <div>
          ...
          <Button
            className="mt-5"
            text={isSuccess ? resultType[0].textButton : resultType[1].textButton}
            onClick={onClose}
          />
        </div>
      </div>
